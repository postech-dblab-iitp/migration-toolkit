...
public class TurboToTiberoTypeMapPage extends
		PreferencePage implements
		IWorkbenchPreferencePage {
	private DataTypeMappingComposite container;

	public TurboToTiberoTypeMapPage() {
		super("Turbo To Tibero", null);
	}
	...
	protected Control createContents(Composite parent) {
		...
		container = new DataTypeMappingComposite(com, MigrationTransFactory.getTransformHelper(
				DatabaseType.TURBO, DatabaseType.TIBERO).getDataTypeMappingHelper());
		return com;
	}
	...
	protected void contributeButtons(Composite parent) {
		...
		btnSave.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent ev) {
				...
				dialog.setFileName("Turbo2Tibero.xml");
